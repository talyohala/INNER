            ...
            {items.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {isActive && <motion.div layoutId="activeNavTab" className="absolute -bottom-1 w-5 h-1 bg-accent-primary rounded-full" transition={{ type: "spring", stiffness: 300, damping: 30 }} />}
                </button>
              );
            })}
          </div>
