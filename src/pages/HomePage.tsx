...
export const HomePage: React.FC = () => {
      ...
      if (target.scrollHeight - target.scrollTop <= target.clientHeight * 2 && fullScreenMedia) {
        ...
        if (more.length) {
          setFullScreenMedia((prev) => [...(prev || []), ...more]);
           ...
           // אם אין פוסטים חדשים, נמחזר קיימים כדי לשמור על הלופ
           const recycle = posts.filter(p => p.media_url).sort(() => Math.random() - 0.5).slice(0, 3);
           setFullScreenMedia(prev => [...(prev || []), ...recycle]);
        }
      }
    }, 150);
  };
  ...
  return (
    <>
      {/* Container wrapper required for the entire component */}
      <div className="relative w-full min-h-screen">
        ...
        <FadeIn
          className="px-0 pt-8 pb-32 bg-[#030303] min-h-screen relative overflow-x-hidden touch-pan-y"
          dir="rtl"
        ...
        >
          ...
          >
            <div className="bg-[#111] p-2.5 rounded-full shadow-2xl border border-white/10 mt-6 backdrop-blur-xl">
              <RefreshCw size={22} className={`text-white ${refreshing ? 'animate-spin' : ''}`} />
            </div>
          </div>
          ...
          <div className="relative z-10 px-4">
            <div className="flex justify-between items-start mb-8 h-12">
              ...
              <button
                ...
                className="w-10 h-10 flex justify-center items-center bg-white/[0.04] border border-white/10 rounded-full active:scale-90 relative shadow-sm backdrop-blur-sm"
              >
                <Bell size={18} className="text-white" />
                {unreadCount > 0 && (
                  <span className="absolute top-2 right-2.5 w-2 h-2 bg-[#e91e63] rounded-full border border-black animate-pulse" />
                )}
              </button>
            </div>

            {/* תיבת העלאה Edge to Edge */}
            <div className="w-full rounded-[32px] mb-8 border border-white/10 bg-white/[0.04] backdrop-blur-md shadow-2xl relative z-10 flex flex-col gap-3 overflow-hidden">
              {selectedFile && (
                <div className="relative w-full h-36 bg-[#111] border-b border-white/10 flex items-center justify-center">
              ...
              <div className="p-5 flex flex-col">
                ...
                <div className="flex justify-end items-center gap-4 border-t border-white/10 pt-4 mt-2">
                  <div
          ...
          <div className="flex flex-col gap-6 relative z-10 px-4">
            {posts.map((post) => {
              ...
              return (
                <div
                  key={post.id}
                  className="flex flex-col rounded-[32px] bg-[#0A0A0A] border border-white/10 overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.5)] w-full"
                >
                  {/* מדיה למעלה - Edge to Edge בתוך המעטפת המעוגלת */}
                  {hasMedia && (
                    <div
                      className="w-full bg-[#050505] relative cursor-pointer rounded-t-[32px] overflow-hidden"
                      onClick={() =>
                        openOverlay(() => {
                  ...
                  {post.user_circles && post.user_circles.length > 0 && (
                    <div className="px-5 py-4 border-b border-white/5 bg-[#050505]">
                      <h4 className="text-white/30 text-[10px] font-black mb-3 uppercase tracking-wider text-right w-full">
                        שייך למועדונים:
                      </h4>
                          ...
                          >
                            <div className="w-12 h-12 rounded-full border border-white/10 overflow-hidden bg-[#111]">
                              {circle.cover_url ? (
                                ...
                                <div className="w-full h-full flex items-center justify-center text-white/20 font-black">{circle.name?.charAt(0)}</div>
                              )}
                            </div>
                  ...
                  {/* Footer - משתמש מימין, פעולות משמאל */}
                  <div className="flex items-center justify-between px-5 py-4 bg-[#0A0A0A] rounded-b-[32px]">
                    <div className="flex items-center gap-4 mr-auto" dir="ltr">
                      <button
                        onClick={() => openOverlay(() => setOptionsMenuPost(post))}
                        className="text-white/30 active:scale-90 transition-colors p-1 hover:text-white"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 text-white/30 active:scale-90 hover:text-[#2196f3] transition-colors"
                      >
                      ...
                      <button
                        ...
                        className={`flex items-center gap-1.5 active:scale-90 transition-colors ${
                          post.is_liked ? 'text-red-500' : 'text-white/30 hover:text-red-400'
                        }`}
                      >
                        <span className="text-[13px] font-black">{post.likes_count}</span>
                        <Heart size={20} fill={post.is_liked ? 'currentColor' : 'none'} strokeWidth={post.is_liked ? 0 : 2} />
                      </button>
                    </div>
      ...
      {/* PORTALS (MODALS) - Without createPortal, using High Z-Index */}
      {mounted && (
        <AnimatePresence>
          {fullScreenMedia && (
            <motion.div
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end pointer-events-none">
                        ...
                        <div className="flex items-center justify-between w-full pointer-events-auto pr-2 pb-4">
                          {/* שמאל - פעולות (מסך מלא) */}
                          <div className="flex items-center gap-4 mr-auto" dir="ltr">
                            <button
                              onClick={(e) => {
                              ...
                              className="text-white/80 hover:text-white p-1 active:scale-90 transition-transform"
                            >
                            ...
                            <button
                              ...
                              className="flex items-center gap-1.5 text-white/80 hover:text-white active:scale-90 transition-transform"
                            >
                              <span className="text-[15px] font-black drop-shadow-md">
                                {vid.comments_count}
                              </span>
                            ...
                            <button
                              ...
                              className={`flex items-center gap-1.5 active:scale-90 transition-transform ${
                                vid.is_liked ? 'text-red-500' : 'text-white/80 hover:text-red-400'
                              }`}
                            >
                              <span className="text-[15px] font-black drop-shadow-md">
                                {vid.likes_count}
                              ...
                              <Heart
                                ...
                                strokeWidth={vid.is_liked ? 0 : 1.5}
                              />
                            </button>
                          </div>
                          ...
                          >
                            <div className="flex flex-col text-right">
                              ...
                              <span className="text-white/60 text-[10px] font-bold mt-0.5 drop-shadow-md">
          ...
          {activeCommentsPostId && (
            ...
            >
              ...
              <motion.div
                ...
                className="relative z-10 bg-[#0A0A0A] rounded-t-[36px] h-[80vh] flex flex-col overflow-hidden pb-10 shadow-[0_-10px_50px_rgba(0,0,0,0.8)] border-t border-white/10"
              >
                ...
                >
                  {loadingComments ? (
                    <Loader2 className="animate-spin mx-auto text-white/20 mt-4" />
                  ) : (
                    comments
                          ...
                          <div key={c.id} className="flex flex-col gap-2">
                            <div className="flex gap-3">
                              ...
                              <div className="flex flex-col flex-1">
                                <div
                                  className="bg-[#111] p-3 rounded-2xl rounded-tr-sm cursor-pointer"
                                ...
                                <div key={reply.id} className="flex gap-3 pr-10 mt-2 relative">
                                  ...
                                  <div className="flex flex-col flex-1 z-10">
                                    ...
                                    >
                                      ...
                                      <p className="text-white/70 text-[13px] whitespace-pre-wrap leading-relaxed">
                                        {reply.content}
                                      </p>
                                    </div>
                ...
                <div className="p-4 border-t border-white/5 flex flex-col gap-2 bg-[#050505]" onPointerDown={stopPropagation}>
                  ...
                  <div className="flex gap-2 items-center bg-white/5 rounded-full p-1 pl-2 border border-white/10">
                    ...
                    <button
                      ...
                      className="w-9 h-9 bg-[#2196f3] rounded-full flex items-center justify-center text-white active:scale-95 disabled:opacity-50 transition-opacity"
                    >
          ...
          {optionsMenuPost && (
            ...
            >
              ...
              <motion.div
                ...
                animate={{ y: 0 }}
                exit={{ y: '100%' }}
                className="relative z-10 bg-[#0A0A0A] rounded-t-[36px] p-6 flex flex-col gap-2 pb-12 shadow-[0_-10px_50px_rgba(0,0,0,0.8)] border-t border-white/10"
              >
                ...
                <button
                  ...
                  className="w-full p-4 bg-white/5 rounded-full text-white/90 font-bold flex justify-between items-center text-lg active:bg-white/10 transition-colors"
                >
                ...
                {optionsMenuPost.user_id === currentUserId && (
                  <>
                    ...
                    <button
                      ...
                      className="w-full p-4 bg-red-500/10 border border-red-500/20 rounded-full text-red-500 font-bold flex justify-between items-center text-lg mt-2 active:bg-red-500/20 transition-colors"
                    >
                      <span>מחק פוסט</span><Trash2 size={20} />
                    </button>
                  </>
                )}
              </motion.div>
          ...
          {commentActionModal && (
            ...
            >
              ...
              <motion.div
                ...
                animate={{ y: 0 }}
                exit={{ y: '100%' }}
                className="relative z-10 bg-[#0A0A0A] rounded-t-[36px] p-6 flex flex-col gap-3 pb-12 shadow-[0_-10px_50px_rgba(0,0,0,0.8)] border-t border-white/10"
              >
                <div className="w-full py-4 flex justify-center cursor-grab active:cursor-grabbing">
                  <div className="w-16 h-1.5 bg-white/20 rounded-full" />
                </div>
                ...
                >
                  <span>השב לתגובה</span><Reply size={20} className="text-[#2196f3]" />
                </button>
                ...
                {commentActionModal.user_id === currentUserId && (
                  <>
                    <button
                      ...
                      className="w-full p-4 bg-white/5 rounded-full text-white/90 font-bold flex justify-between items-center text-lg hover:bg-white/10 transition-colors mt-2"
                    >
                      <span>ערוך תגובה</span><Edit2 size={20} className="text-white/40" />
                    </button>
          ...
          {userCirclesModal && (
            ...
            >
              ...
              <motion.div
                ...
                animate={{ y: 0 }}
                exit={{ y: '100%' }}
                className="relative z-10 bg-[#0A0A0A] rounded-t-[36px] p-6 flex flex-col gap-3 pb-12 max-h-[70vh] shadow-[0_-10px_50px_rgba(0,0,0,0.8)] border-t border-white/10"
              >
                <div className="w-full py-4 flex justify-center cursor-grab active:cursor-grabbing">
                  <div className="w-16 h-1.5 bg-white/20 rounded-full" />
                </div>
                ...
                >
                  {userCirclesModal.map((c: any) => (
                    <div
                      ...
                      className="flex items-center gap-4 bg-white/5 p-3 rounded-full cursor-pointer border border-white/5"
                    >
                      <div className="w-12 h-12 rounded-full bg-[#111] overflow-hidden border border-white/10 shrink-0">
                        {c.cover_url ? (
                          ...
                          <Users size={20} className="m-3 text-white/30" />
                        )}
                      </div>
          ...
          {showCreatePost && (
            ...
            >
              ...
              <motion.div
                ...
                animate={{ y: 0 }}
                exit={{ y: '100%' }}
                className="relative z-10 bg-[#0A0A0A] rounded-t-[36px] p-6 flex flex-col gap-4 pb-12 shadow-[0_-10px_50px_rgba(0,0,0,0.8)] border-t border-white/10"
              >
                <div className="w-full py-4 flex justify-center cursor-grab active:cursor-grabbing">
                  <div className="w-16 h-1.5 bg-white/20 rounded-full" />
                </div>
                ...
                <textarea
                  ...
                  className="h-32 bg-[#111] rounded-[24px] p-5 text-white text-[16px] outline-none resize-none border border-white/10 placeholder:text-white/40 shadow-inner"
                  onPointerDown={stopPropagation}
                  onTouchStart={stopPropagation}
                />
                ...
                {!editingPost && (
                  <div
                    onClick={() => fileInputRef.current?.click()}
                    className="p-5 bg-[#111] rounded-full border-2 border-dashed border-white/10 text-center text-white/50 cursor-pointer hover:bg-white/5 transition-colors"
                  >
                ...
                <Button
                  ...
                  className="h-14 bg-[#2196f3] text-white font-black rounded-full mt-2 shadow-md"
                >
          ...
          {activeDescPost && (
            ...
            >
              ...
              <motion.div
                ...
                animate={{ y: 0 }}
                exit={{ y: '100%' }}
                className="relative z-10 bg-[#0A0A0A] rounded-t-[36px] flex flex-col overflow-hidden pb-10 max-h-[75vh] shadow-[0_-10px_50px_rgba(0,0,0,0.8)] border-t border-white/10"
              >
                <div className="w-full py-6 flex justify-center cursor-grab active:cursor-grabbing border-b border-white/5">
                  <div className="w-16 h-1.5 bg-white/20 rounded-full" />
                </div>
                ...
                <div
                  ...
                  onTouchStart={stopPropagation}
                >
                  <p className="text-white/90 text-[15px] leading-relaxed text-right whitespace-pre-wrap">
