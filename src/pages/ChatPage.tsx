    ...
    <div className="flex flex-col h-screen bg-[#0A0A0A]" dir="rtl">
      <div className="flex items-center justify-between p-4 bg-[#111] border-b border-white/10 shrink-0 mt-8">
        <div className="flex items-center gap-3">
          ...
          <div className="w-10 h-10 rounded-full bg-black overflow-hidden border border-white/20 flex items-center justify-center">
      ...
      <div className="p-4 bg-[#111] border-t border-white/10 shrink-0 pb-10">
        <div className="flex gap-2 items-center bg-black/40 rounded-full p-1 pl-2 border border-white/10">
          ...
          <button onClick={sendMessage} disabled={!newMessage.trim()} className="w-10 h-10 bg-[#2196f3] rounded-full flex items-center justify-center text-white active:scale-95 disabled:opacity-50 transition-opacity shadow-md"><Send size={18} className="rtl:-scale-x-100 -ml-1" /></button>
        </div>
      </div>
    </div>
  );
