...
import {
  ...
  MessageSquare, Mail, Crown, EyeOff, Lock, User, Loader2, Zap, Globe
} from 'lucide-react';
        ...
        return (
          <div className="flex flex-col items-center justify-center text-center py-6 gap-6">
            ...
            <div className="flex flex-col gap-2 w-full max-w-[280px]">
                <div className="flex justify-between items-center p-3 bg-surface-card rounded-2xl border border-surface-border">
        ...
        return (
          <div className="flex flex-col gap-4 py-2">
            {loadingBlocked ? (
              ...
              blockedUsers.map(u => (
                <div key={u.blocked_id} className="flex items-center justify-between p-4 bg-surface-card border border-surface-border rounded-[24px]">
                  ...
                  <button onClick={() => unblockUser(u.blocked_id)} className="px-5 py-2.5 bg-accent-primary/10 border border-accent-primary/30 rounded-xl text-[10px] font-black text-accent-primary hover:bg-accent-primary/20 transition-all uppercase tracking-widest">ביטול חסימה</button>
                </div>
              ))
            )}
          </div>
        ...
        return (
          <div className="flex flex-col gap-6 items-center text-center py-6">
            ...
            <div className="w-full flex flex-col gap-3">
               <div className="flex items-center justify-between p-5 bg-surface-card border border-surface-border rounded-[24px]">
                  <div className="flex items-center gap-3">
                  ...
                  <div className="text-[10px] font-black text-brand-muted uppercase tracking-widest px-3 py-1 bg-white/5 rounded-lg border border-white/5">ראשי</div>
               </div>
               <p className="text-[11px] text-brand-muted leading-relaxed px-4 text-center font-medium">
        ...
        return (
          <div className="flex flex-col gap-6 text-right py-4 text-brand-muted">
            ...
            <div className="space-y-6 font-medium">
                ...
                <div className="p-4 bg-surface-card rounded-2xl border border-surface-border space-y-3">
                    <div className="flex items-center gap-3">
                        <Globe size={16} className="text-accent-primary" />
                        <span className="text-xs font-black text-brand uppercase tracking-widest">התאמות שבוצעו:</span>
                    </div>
