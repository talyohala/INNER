        ...
        <AnimatePresence mode="wait">
          ...
          {search.trim() ? (
            ...
            <motion.div key="explore-home" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="flex flex-col gap-8 pb-10">                  
              ...
              <div onClick={() => { triggerFeedback('pop'); toast.success('הדרופ נפתח!'); }} className="mx-4 relative overflow-hidden rounded-[24px] cursor-pointer group active:scale-[0.98] transition-transform shadow-lg border border-surface-border">                                                                   
                ...
                <div className="relative p-6 flex items-center justify-between z-10">                                               
                  ...
                  <button className="h-12 w-12 rounded-full bg-white text-black flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                ...
                <div className="flex items-center gap-2 min-w-max pb-1 overflow-x-auto scrollbar-hide px-4">                        
                  {CATEGORY_TREE.map((cat) => (
                    <button
                      ...
                      className={`px-5 py-2.5 rounded-full text-[13px] font-black tracking-wide transition-all border active:scale-95 ${                                                                           
                    ...
                    <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="flex overflow-x-auto scrollbar-hide gap-2 px-4 mt-1">                                            
                      {currentCatObj.sub.map((subName) => (
                        <button
                          ...
                          className={`shrink-0 h-8 px-4 rounded-full font-bold text-[11px] transition-all border active:scale-95 ${                                                                                    
                            activeSub === subName                                      
